<template>
  <div
    class="flex flex-wrap flex-row bg-[#d5bda5be] w-[35%] min-h-[80vh] absolute right-0 top-[10rem] overflow-y-auto max-h-[81vh] scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-200"
  >
